...
<a href="login.php">login</a>
	...
	?>
		<div class="product-item">
			...
			<a href='get-product-info.php?id=<?php echo $product_array[$key]["id"];?>'target="_blank"onclick="tan()">click</a>
			<div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" size="2" /><input type="submit" value="Add to Cart" class="btnAddAction" style="width:150px;height:60px"/></div>
